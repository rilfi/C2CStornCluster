...
public class RT_Das_rich_Bolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
        ...
        Object metaDataArray[]={returnMap.get("MSG"),Long.parseLong(returnMap.get("TID_NER")),Long.parseLong(returnMap.get("TID_STA")),Long.parseLong(returnMap.get("TID_MOD")),Long.parseLong(returnMap.get("TID_GRO")),returnMap.get("USER"),returnMap.get("URL"),returnMap.get("LOC")};
        Object correlationdataArray[]={Long.parseLong(returnMap.get("STARTED")),Long.parseLong(returnMap.get("TPLSTART")),Long.parseLong(returnMap.get("TT_NER")),Long.parseLong(returnMap.get("AV_NER")),Long.parseLong(returnMap.get("TT_STA")),Long.parseLong(returnMap.get("AV_STA")),Long.parseLong(returnMap.get("TT_MOD")),Long.parseLong(returnMap.get("AV_MOD")),Long.parseLong(returnMap.get("TT_GRO")),Long.parseLong(returnMap.get("AV_GRO")),Long.parseLong(returnMap.get("CNT_NER")),Long.parseLong(returnMap.get("CNT_STA")),Long.parseLong(returnMap.get("CNT_MOD")),Long.parseLong(returnMap.get("CNT_GRO"))};
